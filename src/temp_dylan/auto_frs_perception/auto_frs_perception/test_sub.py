...
class TestSub(Node):
    def __init__(self):
        ...
        with open(labels_path, 'r') as f:
            # lines look like "0 class_name" → keep the text after the first space
        ...
        # --- NEW: configurable image topic (defaults to Husky-style; override for drone) ---
        ...
        self.get_logger().info(f"Camera + TM classifier started on [{image_topic}]")
